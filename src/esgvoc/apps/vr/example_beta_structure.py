...
def demonstrate_filtering():
    ...
    with VRApp() as vr_app:
        ...
        var_terms = vr_app.get_branded_variables_subset({
            "variable_root_name": ["ta", "tas", "clt"]
        })
        ...
        cf_terms = vr_app.get_branded_variables_subset({
        ...
        combined_terms = vr_app.get_branded_variables_subset({
            "realm": "atmos",
            "cf_standard_name": "air_temperature"
        })
